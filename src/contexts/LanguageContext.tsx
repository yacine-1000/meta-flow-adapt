...
const translations: Record<string, Record<Language, string>> = {
  ...
  "intro.create_plan": { en: "Create my plan", ar: "سو لي خطة" },
  "intro.takes_30s": { en: "Takes about 30 seconds", ar: "بياخذ 30 ثانية تقريبًا" },

  // Slide 1 card content
  "intro.upper_body": { en: "Upper Body", ar: "الجزء العلوي" },
  "intro.push_pull": { en: "Push + Pull", ar: "دفع + سحب" },
  "intro.min": { en: "min", ar: "د" },
  "intro.bench_press": { en: "Bench Press", ar: "بنش برس" },
  "intro.incline_fly": { en: "Incline Fly", ar: "فلاي مائل" },
  "intro.barbell_row": { en: "Barbell Row", ar: "تجديف بار" },
  "intro.sets_reps1": { en: "4 sets · 8-10 reps", ar: "٤ مجموعات · ٨-١٠ تكرارات" },
  "intro.sets_reps2": { en: "3 sets · 12 reps", ar: "٣ مجموعات · ١٢ تكرار" },
  "intro.weekly_progress": { en: "Weekly Progress", ar: "التقدم الأسبوعي" },

  // Slide 2 card content – Sports
  "intro.s2_football": { en: "Football", ar: "كرة قدم" },
  "intro.s2_padel": { en: "Padel", ar: "بادل" },
  "intro.s2_running": { en: "Running", ar: "جري" },
  "intro.s2_swimming": { en: "Swimming", ar: "سباحة" },
  "intro.s2_cycling": { en: "Cycling", ar: "دراجة" },
  "intro.s2_weekly_view": { en: "Weekly Balance", ar: "توازن الأسبوع" },
  "intro.s2_sport_aware": { en: "Sport-aware scheduling", ar: "جدولة تراعي رياضاتك" },
  "intro.s2_recovery": { en: "Recovery adjusted", ar: "تعافي معدّل" },
  "intro.s2_load_managed": { en: "Load managed", ar: "الحمل محسوب" },
  "intro.s2_2x_week": { en: "2× / week", ar: "٢× / أسبوع" },
  "intro.s2_3x_week": { en: "3× / week", ar: "٣× / أسبوع" },
  "intro.s2_lifting": { en: "Lifting", ar: "حديد" },
  "intro.s2_sport": { en: "Sport", ar: "رياضة" },
  "intro.s2_rest": { en: "Rest", ar: "راحة" },

  // Slide 3 card content – Plan Adaptation
  "intro.s3_equipment": { en: "Equipment", ar: "المعدات" },
  "intro.s3_dumbbells": { en: "Dumbbells", ar: "دمبلز" },
  "intro.s3_barbell": { en: "Barbell", ar: "بار" },
  "intro.s3_cable": { en: "Cable", ar: "كابل" },
  "intro.s3_bench": { en: "Bench", ar: "بنش" },
  "intro.s3_shoulder_injury": { en: "Shoulder", ar: "الكتف" },
  "intro.s3_adapted": { en: "Exercises adapted", ar: "التمارين معدّلة" },
  "intro.s3_session_time": { en: "Session Time", ar: "مدة الجلسة" },
  "intro.s3_avg_session": { en: "Avg per session", ar: "متوسط الجلسة" },
  "intro.s3_your_goal": { en: "Your Goal", ar: "هدفك" },
  "intro.s3_muscle_growth": { en: "Muscle Growth", ar: "بناء العضلات" },
  "intro.s3_primary_goal": { en: "Primary goal", ar: "الهدف الرئيسي" },
  "intro.s3_plan_adapts": { en: "Plan adapts to your real situation", ar: "الخطة تتكيّف مع وضعك الفعلي" },
  "intro.s3_no_overhead": { en: "No overhead press", ar: "بدون ضغط علوي" },
  "intro.s3_alt_selected": { en: "Alternatives selected", ar: "تم اختيار بدائل" },

  // Slide 4 card content – Action / Loss Aversion
  "intro.s4_exercise": { en: "Exercise", ar: "التمرين" },
  "intro.s4_sets": { en: "Sets", ar: "مجموعات" },
  "intro.s4_reps": { en: "Reps", ar: "تكرارات" },
  "intro.s4_bench_press": { en: "Bench Press", ar: "بنش برس" },
  "intro.s4_squat": { en: "Squat", ar: "سكوات" },
  "intro.s4_lat_pulldown": { en: "Lat Pulldown", ar: "سحب عالي" },
  "intro.s4_shoulder_press": { en: "Shoulder Press", ar: "ضغط كتف" },
  "intro.s4_your_plan": { en: "Your Plan", ar: "خطتك" },
  "intro.s4_ready": { en: "Ready", ar: "جاهزة" },
  "intro.s4_personalized": { en: "Personalized for you", ar: "مخصصة لك" },
  "intro.s4_week1": { en: "Week 1", ar: "الأسبوع ١" },
  "intro.s4_progress": { en: "Clear direction", ar: "اتجاه واضح" },
  "intro.s4_structured": { en: "Structured", ar: "منظّم" },
  "intro.s4_no_guesswork": { en: "No guesswork", ar: "بدون تخمين" },
  "intro.s4_day_upper": { en: "Day 1 · Upper Body", ar: "يوم ١ · علوي" },
  "intro.s4_exercises_count": { en: "6 exercises", ar: "٦ تمارين" },
  "intro.s4_est_time": { en: "~50 min", ar: "~٥٠ د" },
