...
const translations: Record<string, Record<Language, string>> = {
  ...
  "intro.upper_body": { en: "Upper Body", ar: "جزء علوي" },
  "intro.push_pull": { en: "Push · Pull · Shoulders", ar: "دفع · سحب · أكتاف" },
  "intro.min": { en: "min", ar: "د" },
  "intro.bench_press": { en: "Dumbbell Bench Press", ar: "بنش بريس دمبل" },
  "intro.incline_fly": { en: "Incline DB Fly", ar: "فلاي مائل دمبل" },
  "intro.barbell_row": { en: "Barbell Row", ar: "تجديف بار" },
  "intro.sets_reps1": { en: "3 sets · 8-10 reps", ar: "3 مجموعات · 8-10 تكرارات" },
  "intro.sets_reps2": { en: "3 sets · 10-12 reps", ar: "3 مجموعات · 10-12 تكرارات" },
  "intro.weekly_progress": { en: "Weekly Progress", ar: "تقدم الأسبوع" },
  "intro.cycling": { en: "Cycling", ar: "دراجة" },
  "intro.running": { en: "Running", ar: "جري" },
  "intro.padel": { en: "Padel", ar: "بادل" },
  "intro.sport_aware": { en: "Sport-aware plan adaptation", ar: "خطة تراعي رياضاتك" },
  "intro.day_m": { en: "M", ar: "ن" },
  "intro.day_t": { en: "T", ar: "ث" },
  "intro.day_w": { en: "W", ar: "ر" },
  "intro.day_th": { en: "T", ar: "خ" },
  "intro.day_f": { en: "F", ar: "ج" },
  "intro.day_s": { en: "S", ar: "س" },
  "intro.day_su": { en: "S", ar: "ح" },
  "intro.equipment": { en: "Equipment", ar: "المعدات" },
  "intro.dumbbells": { en: "Dumbbells", ar: "دمبلز" },
  "intro.barbell": { en: "Barbell", ar: "بار" },
  "intro.cable": { en: "Cable", ar: "كيبل" },
  "intro.shoulder": { en: "Shoulder", ar: "كتف" },
  "intro.adapted": { en: "Adapted movements", ar: "تمارين معدّلة" },
  "intro.avg_session": { en: "Avg session", ar: "متوسط الجلسة" },
  "intro.muscle": { en: "Muscle", ar: "عضلات" },
  "intro.primary_goal": { en: "Primary goal", ar: "الهدف الأساسي" },
  "intro.plan_adapts": { en: "Plan adapts to your situation", ar: "الخطة تتكيف مع وضعك" },
  "intro.day_streak": { en: "Day streak", ar: "أيام متتالية" },
  "intro.this_week": { en: "This week", ar: "هالأسبوع" },
  "intro.days_count": { en: "3/4 days", ar: "3/4 أيام" },
  "intro.all_done": { en: "All exercises done", ar: "كل التمارين خلصت" },
  "intro.est_volume": { en: "Est. Volume", ar: "الحجم التقديري" },
  "intro.lbs": { en: "lbs", ar: "باوند" },
 ": { en: "Next", ar: "التالي" },
